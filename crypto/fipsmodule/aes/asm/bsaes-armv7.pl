...
#ifdef	__APPLE__
	mov	$ctr, #:lower16:(.LRSVM0SR-.LM0)
	add	$ctr, $const, $ctr
#else
	add	$ctr, $const, #.LRSVM0SR-.LM0	@ borrow $ctr
#endif
...
.Lctr_enc_loop:
	...
	add		r4, $key, #`248+16`
#endif
	vldmia		$ctr, {@XMM[8]}			@ .LRSVM0SR
	mov		r5, $rounds			@ pass rounds
	vstmia		$fp, {@XMM[10]}			@ save next counter
#ifdef	__APPLE__
	mov		$const, #:lower16:(.LRSVM0SR-.LSR)
	sub		$const, $ctr, $const
#else
	sub		$const, $ctr, #.LRSVM0SR-.LSR	@ pass constants
#endif
